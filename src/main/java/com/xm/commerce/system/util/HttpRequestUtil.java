...
import com.xm.commerce.system.response.WeChatResult;
...
public class HttpRequestUtil {
     ...
     * @return
     */
    public static String HttpsDefaultExecute(String method, String path, String data) {
        String result = "";
        try {
    ...
    public static String HttpsDefaultExecute(String method, String path) {
        String result = "";
        try {
            result = defaultConnection(method, path, DEFAULT_CONNTIME, DEFAULT_READTIME);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
     ...
     * @return
     */
    private static WeChatResult InputStreamToMedia(InputStream input, String savePath, String type) {
        WeChatResult result = new WeChatResult();
        try {
            File file = null;
